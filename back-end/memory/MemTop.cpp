...
void Mem_Top::conn_module() {
    load_queue->ren2lsu = ren2lsu;
    load_queue->lsu2ren = lsu2ren;
    store_queue->ren2lsu = ren2lsu;
    store_queue->lsu2ren = lsu2ren;
    addr_trans_arb->lsu_req = lsu_req;
    load_queue->bcast_bus = bcast_bus;
    load_queue->rob2ldq = rob2ldq;
    store_queue->rob2stq = rob2stq;
