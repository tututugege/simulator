...
constexpr uint64_t MAX_SIM_TIME = 10000000; // 1T cycles (very large)
...
#define CONFIG_AXI_KIT_SIM_DDR_WRITE_RESP_LATENCY 2
#endif
#ifndef CONFIG_AXI_KIT_SIM_DDR_BEAT_BYTES
#define CONFIG_AXI_KIT_SIM_DDR_BEAT_BYTES 4
#endif
