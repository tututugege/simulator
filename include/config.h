...
constexpr int IDU_INST_BUFFER_SIZE = 128;
...
constexpr int MAX_WAKEUP_PORTS =
    ...
    count_ports_with_mask(OP_MASK_MUL | OP_MASK_DIV | OP_MASK_FP | OP_MASK_CSR);
...
constexpr uint32_t UART_PLIC_IRQ_ID = 0x0000000A;
constexpr uint32_t DMA_PLIC_IRQ_ID = 0x0000000B;
constexpr uint32_t XPS_INTC_ADDR_BASE = 0x1fb00000;
constexpr uint32_t XPS_INTC_MMIO_SIZE = 0x00001000;
...
constexpr uint32_t DMA_ADDR_BASE = 0x1fd0f000;
constexpr uint32_t DMA_MMIO_SIZE = 0x00000100;
constexpr uint32_t DMA_SRC_ADDR = 0x1fd0f000;
constexpr uint32_t DMA_DST_ADDR = 0x1fd0f004;
constexpr uint32_t DMA_LEN_ADDR = 0x1fd0f008;
constexpr uint32_t DMA_CTRL_ADDR = 0x1fd0f00c;
constexpr uint32_t DMA_STATUS_ADDR = 0x1fd0f010;
